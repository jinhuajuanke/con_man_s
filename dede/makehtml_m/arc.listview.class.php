...
class ListViewMobile
{
    ...
    function __construct($typeid, $uppage=1)
    {
        ...
        $this->TypeLink = new TypeLinkm($typeid);
    ...
    {
        global $cfg_remote_site,$dedemao_path,$dedemao_typerule,$dedemao_usetype;
        if(empty($startpage))
        {
            $startpage = 1;
        }
        ...
        if($dedemao_usetype==0 && $dedemao_typerule){
            ...
            $this->Fields['typedir'] = '{cmspath}'.$dedemao_path.$typedir;
            $this->Fields['typedir'] = substr($this->Fields['typedir'],0,9).$dedemao_path.substr($this->Fields['typedir'],9);
            $this->Fields['namerule2'] = $dedemao_typerule;
        }else{
            $typedir = str_replace("{cmspath}","",$this->Fields['typedir']);
            $this->Fields['typedir'] = '{cmspath}'.$dedemao_path.$typedir;
        }
